...
\begin{columns}
    ...
    \block{Combinatorial problem solving}{
        ...
        \begin{wrapfigure}{l}{0.35\linewidth} % {l} for left, 35% of width
            \centering
    ...
    Li, J., Jiang, N., Xue, Y.: Solving Satisfiability Modulo Counting Exactly 
    with Probabilistic Circuits (2025)
