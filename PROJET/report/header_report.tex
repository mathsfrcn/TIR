...
\newtcolorbox{exampleBox}[1][]{%
  colback=blue!10!white,     % fond bleu clair
  colframe=blue!50!black,    % bordure un peu foncée
  colbacktitle=blue!30,      % fond de l'en-tête
  coltitle=white,            % texte de l'en-tête en blanc
  arc=4mm,
  boxrule=0.8pt,
  left=6pt, right=6pt, top=6pt, bottom=6pt,
  enhanced,
