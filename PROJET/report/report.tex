...
\begin{figure}[H]
    ...
    \caption{Scaling Neuro-symbolic Problem Solving: Solver-Free Learning of Constraints and Objectives \cite{defresne_scaling_2026}.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Example of SMC: Robust Supply Chain with Different Network Size \cite{li_solving_2025}.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/KOCO.png}
    \caption{Performance of each algorithm \cite{li_solving_2025}}
\end{figure}
